...
/***/ function(module, exports, __webpack_require__) {
	...
	var Root = _react2.default.createClass({
	  ...
	  nameChanged: function nameChanged(data) {
	    this.setState({ name: data.target.value });
	    console.log("name changing to : " + this.state.name);
	  },

	  roomChanged: function roomChanged(data) {
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      'div',
	      { id: 'root' },
	      _react2.default.createElement(PreLobby, { createRoom: this.createRoom,
	        name: this.state.name,
	        joinRoom: this.joinRoom,
	        roomName: this.state.roomName,
	        nameChanged: this.nameChanged,
	        roomChanged: this.roomChanged }),
	      _react2.default.createElement(Lobby, { 'class': this.state.inLobby ? '' : 'hidden' })
	    );
	  }
	});
	var PreLobby = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      'div',
	      { id: 'preLobby' },
	      _react2.default.createElement('input', { id: 'n',
	        autoComplete: 'off',
	        value: this.props.name,
	        onChange: this.props.nameChanged }),
	      _react2.default.createElement('input', { id: 'r',
	        autoComplete: 'off',
	...
	var RoomButton = _react2.default.createClass({
	  displayName: 'RoomButton',
	...
	var Lobby = _react2.default.createClass({
	  ...
	  _messageRecieve: function _messageRecieve(msg) {
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      'div',
	      { id: 'lobby', className: this.props.class },
	      _react2.default.createElement(RoomName, { data: "Room ID: " + this.state.roomId }),
	      ...
	      _react2.default.createElement(MessageForm, null)
	    );
	  }
	});
	...
	var MessageForm = _react2.default.createClass({
	  ...
	  textChanged: function textChanged(msg) {
	...
	var RoomName = _react2.default.createClass({
